    ...
    <div>
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "center" }}>
          <Paper style={{ width: "100%", marginTop: "1%", height: "auto" }}>
            {isMatch && (
              <div
                style={{
                  display: "flex",
            ...
            >
              ...
              >
                ...
                حوزه ی طراحی -سابقه‌ی همکاری با شرکت ها و نهادهای مختلف در زمینه
                ی ساخت تیزر و کلیپ های تبلیغاتی -سابقه‌ی تدریس در آموزشگاه‌های
                فنی و حرفه ای و همچنین آموزشگاه‌های خصوصی
              </div>
            </div>
          </Paper>
        </div>
