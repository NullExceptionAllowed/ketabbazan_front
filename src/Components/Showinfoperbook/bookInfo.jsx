      ...
      <Box sx={{ display: "flex", direction: "rtl" }}>
        <Paper variant="outlined" style={paper2style}>
          <center>
            ...
            <Grid>
              <Typography style={typo1}>امتیاز شما به این محصول !؟</Typography>
              <Rating
        ...
        <Paper variant="outlined" style={paper1style}>
          <Grid>
            ...
            <Typography style={typo7}>{bookinfo.summary}</Typography>
          </Grid>
        </Paper>
        ...
        <Paper variant="outlined" style={paper3style}>
          <center>
            <Button
              startIcon={
                <PictureAsPdfIcon style={{ margin: "auto -65px auto auto" }} />
              }
              variant="outlined"
              style={{
                backgroundColor: "CAE5F3",
            ...
            <Button
              startIcon={
                <MarkChatReadIcon style={{ margin: "auto -65px auto auto" }} />
              }
              variant="outlined"
              component={Link}
              style={{
            ...
            <Button
              startIcon={
                <AutoStoriesIcon style={{ margin: "auto -50px auto auto" }} />
              }
              variant="outlined"
              component={Link}
              style={{
            ...
            <Button
              startIcon={
                <MenuBookIcon style={{ margin: "auto -65px auto auto" }} />
              }
              variant="outlined"
              component={Link}
              style={{
